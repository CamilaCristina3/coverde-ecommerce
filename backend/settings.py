...
import os
from decouple import config  # Usando python-decouple para variáveis sensíveis
...
INSTALLED_APPS = [
    ...
    'django_extensions',
    # Local
    'ecommerce_coverde.apps.EcommerceCoverdeConfig',
    'crispy_forms',
    'crispy_bootstrap5',
]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'libraries': {
                'custom_tags': 'ecommerce_coverde.templatetags.custom_tags',
            },
        },
    },
]
...
DATABASES = {
    'default': {
        ...
        'NAME': 'lojacoverde',  # EXATAMENTE como está no MySQL
        'USER': 'root',
        'PASSWORD': '0000',  # Substitua pela senha real
        'HOST': 'localhost',
        'PORT': '3306',
        'OPTIONS': {
...
LOGOUT_REDIRECT_URL = 'ecommerce_coverde:index'
