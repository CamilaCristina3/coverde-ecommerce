...
from coverde_ecommerce.views import IndexView
from coverde_ecommerce.views.auth import (
...
from  coverde_ecommerce.views.carrinho import (
...
from  coverde_ecommerce.views.perfil import (
