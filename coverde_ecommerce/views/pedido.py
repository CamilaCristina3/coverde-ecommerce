...
from coverde_ecommerce.models import Pedido, ItemPedido, Carrinho
...
class PedidoDetailView(LoginRequiredMixin, DetailView):
    model = Pedido
    template_name = 'coverde_ecommerce/pedido/pedido_detail.html'
...
class PedidoCreateView(LoginRequiredMixin, CreateView):
    ...
    template_name = 'coverde_ecommerce/pedido/pedido_create.html'
    success_url = reverse_lazy('coverde_ecommerce:pedido_list')
...
class PedidoUpdateView(LoginRequiredMixin, UpdateView):
    model = Pedido
    form_class = PedidoForm
    template_name = 'coverde_ecommerce/pedido/pedido_update.html'
    context_object_name = 'pedido'
    
    def get_success_url(self):
        return reverse_lazy('coverde_ecommerce:pedido-detail', kwargs={'pk': self.object.pk})
...
class PedidoCancelView(LoginRequiredMixin, View):
    def post(self, request, *args, **kwargs):
        ...
        return redirect('coverde_ecommerce:pedido_list')

# ======= CARRINHO =======

class CarrinhoView(LoginRequiredMixin, View):
    template_name = 'coverde_ecommerce/pedido/carrinho.html'
...
class CheckoutView(LoginRequiredMixin, View):
    template_name = 'coverde_ecommerce/pedido/checkout.html'
    ...
    def processar_pedido(self, form, request):
        with transaction.atomic():
            ...
            return redirect('coverde_ecommerce:checkout-success', codigo=pedido.codigo)

class CheckoutSuccessView(LoginRequiredMixin, View):
    template_name = 'coverde_ecommerce/pedido/checkout_success.html'
