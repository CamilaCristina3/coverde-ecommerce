...
class CategoriaListView(ListView):
    model = Categoria
    template_name = 'coverde_ecommerce/categoria/listagem.html'
...
class CategoriaCreateView(CategoriaAdminMixin, SuccessMessageMixin, CreateView):
    model = Categoria
    template_name = 'coverde_ecommerce/categoria/formulario.html'
    fields = ['nome', 'descricao', 'icone', 'ordem_menu']
    success_url = reverse_lazy('coverde_ecommerce:categoria_listagem')
...
class CategoriaUpdateView(CategoriaAdminMixin, SuccessMessageMixin, UpdateView):
    ...
    template_name = 'coverde_ecommerce/categoria/formulario.html'
    fields = ['nome', 'descricao', 'icone', 'ordem_menu']
    success_url = reverse_lazy('ecoverde_ecommerce:categoria_listagem')
...
class CategoriaDeleteView(CategoriaAdminMixin, SuccessMessageMixin, DeleteView):
    model = Categoria
    template_name = 'coverde_ecommerce/categoria/confirmar_exclusao.html'
    success_url = reverse_lazy('coverde_ecommerce:categoria_listagem')
