# Generated by Django 5.2.2 on 2025-06-14 07:47

import django.core.validators
import django.db.models.deletion
import django.utils.timezone
import ecommerce_coverde.models.models
import uuid
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('imagem_perfil', models.ImageField(blank=True, null=True, upload_to=ecommerce_coverde.models.models.user_directory_path, verbose_name='Imagem de Perfil')),
            ...
            managers=[
                ('objects', ecommerce_coverde.models.models.UtilizadorManager()),
            ],
        ),
        migrations.CreateModel(
            name='Carrinho',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('imagem', models.ImageField(blank=True, null=True, upload_to=ecommerce_coverde.models.models.product_image_upload_path, verbose_name='Imagem Principal')),
                ...
                ('categoria', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='produtos', to='ecommerce_coverde.categoria', verbose_name='Categoria Principal')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preco', models.DecimalField(decimal_places=2, max_digits=10)),
                ('carrinho', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='itens', to='ecommerce_coverde.carrinho')),
                ('produto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ecommerce_coverde.produto')),
            ],
            options={
