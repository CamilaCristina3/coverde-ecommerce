...
from ecommerce_coverde.models import (Utilizador, Produto, Pedido, ItemPedido)
from ecommerce_coverde.forms import (PerfilUpdateForm, ProdutoForm)

class PerfilView(LoginRequiredMixin, DetailView):
    """Visualização detalhada do perfil do usuário com opções de edição"""
    model = Utilizador
    template_name = 'ecommerce_coverde/perfil/perfil.html'
...
class PerfilUpdateView(LoginRequiredMixin, UpdateView):
    ...
    template_name = 'ecommerce_coverde/perfil/perfil_edit.html'
    success_url = reverse_lazy('ecommerce_coverde:perfil')
...
class ProdutorDashboardView(LoginRequiredMixin, TemplateView):
    ...
    template_name = 'ecommerce_coverde/produtor/dashboard.html'
...
class ConsumidorDashboardView(LoginRequiredMixin, TemplateView):
    ...
    template_name = 'ecommerce_coverde/consumidor/dashboard.html'
...
class AdicionarProdutoView(LoginRequiredMixin, CreateView):
    ...
    template_name = 'ecommerce_coverde/produtor/produto_form.html'
    success_url = reverse_lazy('ecommerce_coverde:produtor_dashboard')
...
class EditarProdutoView(LoginRequiredMixin, UpdateView):
    ...
    def get_success_url(self):
        ...
        return reverse_lazy('ecommerce_coverde:produtor_dashboard')
