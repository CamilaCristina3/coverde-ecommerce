...
from ecommerce_coverde.models import Produto, Favorito  # Importação absoluta recomendada

class ProdutoListView(ListView):
    model = Produto
    template_name = 'ecommerce_coverde/produto/listagem-produto.html'
...
class ProdutoDetailView(DetailView):
     model = Produto
     template_name = 'ecommerce_coverde/produto/detalhe-produto.html'
